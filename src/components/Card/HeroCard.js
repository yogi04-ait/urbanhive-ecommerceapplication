  ...
  return (
    <section className="w-full h-full relative">
      ...
      <article className="absolute bottom-20 sm:bottom-40 md:top-60 left-10 md:left-10 lg:left-20 text-white flex flex-col items-start gap-5 md:gap-10 font-satoshi">
        ...
        <button
          className="bg-white text-gray-500 font-semibold px-6 py-3 md:px-8 lg:px-10 md:py-4 text-base sm:text-lg md:text-xl rounded hover:bg-transparent border-2 border-white hover:text-white transition-all duration-300"
        >
          {url}
        </button>
      </article>
